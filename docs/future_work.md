...
focused on credible masked reconstruction for irregular option surfaces.
...
| Japan option transfer | Can U.S.-trained representations adapt to Japanese option chains? | After Japan has matched baselines, fixed OOD splits, and market-specific normalization assumptions. |
